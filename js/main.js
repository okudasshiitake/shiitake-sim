...
function openSns() {
    ...
    $('confirmMessage').innerHTML = `
        ...
        <div style="margin-top:15px; display:flex; flex-direction:column; gap:10px;">
            <button class="btn" style="background:#c00;" onclick="window.open('https://m.youtube.com/@okuda_shiitake', '_blank'); closeEcModal();">▶️ YouTube</button>
            ...
            <button class="btn" style="background:#444;" onclick="window.open('https://www.threads.com/@okuda_shiitake', '_blank'); closeEcModal();">@ Threads</button>
