...
const bgmList = [
    ...
    { file: 'bgm5.mp3', name: 'BGM 5' },
    { file: 'bgm6.mp3', name: 'BGM 6' }
];
...
function startDrying() {
    ...
    if (gameState.totalMoney < 500) {
        showToast('💸', '燃料代500円が足りません');
        return;
    }
    ...
    addEvent(`椎茸${gameState.dryingInventory.length}個を乾燥開始（燃料代-500円）`, 'info');
